...
export default function HomePage() {
  return (
    <div className="h-dvh flex flex-col relative px-6 tablet:px-10">
      <nav className="hidden tablet:flex absolute top-7.5 right-10 gap-7 text-[15px] text-ink z-10">
      ...
      <section className="flex-1 min-h-0 flex flex-col items-center justify-end tablet:justify-center text-center pb-32 tablet:pb-0">
        ...
        <p className="text-[15px] tablet:text-[18px] leading-relaxed tablet:leading-[1.6] text-body max-w-[520px] mb-8 tablet:mb-10">
          I build web applications and care about the craft — clean code,
          thoughtful UX, and things that work well for the people using them.
        </p>

        <nav className="tablet:hidden flex flex-col items-center gap-5.5 mb-7">
          <Link href="/about" className="font-serif text-2xl text-ink">About</Link>
          <Link href="/projects" className="font-serif text-2xl text-ink">Projects</Link>
        </nav>
